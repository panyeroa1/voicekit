...
export class GenAILiveClient {
  ...
  public on<T extends keyof LiveClientEventTypes>(event: T, fn: (...args: Parameters<LiveClientEventTypes[T]>) => void, context?: any): this {
    this.emitter.on(event, fn as any, context);
    return this;
  }

  public off<T extends keyof LiveClientEventTypes>(event: T, fn?: (...args: Parameters<LiveClientEventTypes[T]>) => void, context?: any, once?: boolean): this {
    this.emitter.off(event, fn as any, context, once);
    return this;
  }
